...
# :~$ pip install ta
# tradescope hyperopt --hyperopt GodStraHo --hyperopt-loss SharpeHyperOptLossDaily --spaces all --strategy GodStra --config config.json -e 100
...
from tradescope.optimize.hyperopt_interface import IHyperOpt
