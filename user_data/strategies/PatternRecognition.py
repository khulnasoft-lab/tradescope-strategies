...
from tradescope.strategy import (BooleanParameter, CategoricalParameter, DecimalParameter,
...
class PatternRecognition(IStrategy):
    ...
    # By: @Mablue
    # tradescope hyperopt -s PatternRecognition --hyperopt-loss SharpeHyperOptLossDaily -e 1000
    #
