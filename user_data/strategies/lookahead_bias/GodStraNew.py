...
# tradescope hyperopt --hyperopt-loss SharpeHyperOptLoss --spaces buy roi trailing sell --strategy GodStraNew
# --- Do not remove these libs ---
from tradescope import data
from tradescope.strategy import CategoricalParameter, DecimalParameter
