...
from tradescope.strategy import CategoricalParameter, IntParameter
...
class Strategy005(IStrategy):
    ...
    github@: https://github.com/khulnasoft-lab/tradescope-strategies

    How to use it?
    > python3 ./tradescope/main.py -s Strategy005
    """
    INTERFACE_VERSION = 3
