...
*** NOTE: This Supertrend strategy is just one of many possible strategies using `Supertrend` as indicator. It should on any case used at your own risk.
          It comes with at least a couple of caveats:
            1. The implementation for the `supertrend` indicator is based on the following discussion: https://github.com/khulnasoft-lab/tradescope-strategies/issues/30 . Concretelly https://github.com/khulnasoft-lab/tradescope-strategies/issues/30#issuecomment-853042401
...
from tradescope.strategy import IStrategy, IntParameter
from pandas import DataFrame
import talib.abstract as ta
import numpy as np

class Supertrend(IStrategy):
    # Buy params, Sell params, ROI, Stoploss and Trailing Stop are values generated by 'tradescope hyperopt --strategy Supertrend --hyperopt-loss ShortTradeDurHyperOptLoss --timerange=20210101- --timeframe=1h --spaces all'
    ...
    """
        Supertrend Indicator; adapted for tradescope
        from: https://github.com/khulnasoft-lab/tradescope-strategies/issues/30
    """
