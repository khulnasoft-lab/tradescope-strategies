...
from tradescope.strategy import CategoricalParameter, DecimalParameter, IntParameter
...
class MACDStrategy(IStrategy):
    ...
    tradescope hyperopt --strategy MACDStrategy --hyperopt-loss <someLossFunction> --spaces buy sell
